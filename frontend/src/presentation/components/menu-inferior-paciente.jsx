...
const ABAS_MENU = [
  { chave: "inicio", label: "Inicio", rota: "/paciente/inicio", Icone: Home },
  {
    chave: "consultas",
    label: "Consultas",
    rota: "/paciente/consultas",
    Icone: CalendarDays,
  },
  { chave: "exames", label: "Exames", rota: "/paciente/exames", Icone: TestTube2 },
  {
    chave: "historico",
    label: "Historico",
    rota: "/paciente/historico",
    Icone: FileClock,
  },
  {
    chave: "downloads",
    label: "Downloads",
    rota: "/paciente/downloads",
    Icone: Download,
  },
];
        ...
        {ABAS_MENU.map((aba) => {
          ...
          return (
            <button
              ...
              className={`flex min-h-14 min-w-0 flex-col items-center justify-center gap-1 rounded-lg px-1 py-2 text-[11px] font-semibold transition sm:text-xs ${
                ativa
